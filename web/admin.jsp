                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="0.01" name="costoDia" form="<%= formId%>"
                                           value="<%= p.getCostoDia()%>" class="input-table-edit" required>
                                </td>
                                <td>
                                    <input type="number" name="stock" form="<%= formId%>"
                                           value="<%= p.getStock()%>" class="input-table-edit" required>
                                </td>
                                <td>
                                    <form id="<%= formId%>" action="ActualizarProductoServlet" method="POST" style="display:none;">
                                        <input type="hidden" name="id" value="<%= p.getId()%>">
                                    </form>
                                    <button type="submit" form="<%= formId%>" class="btn-table-save">Guardar</button>
                                </td>
                            </tr>
                            <% }
                    } %>
